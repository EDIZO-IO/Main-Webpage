...
const Logo: React.FC<LogoProps> = ({ isScrolled = false, isFooter = false }) => {
  ...
  return (
    <div className="flex items-center space-x-2 md:space-x-3 transition-all duration-300">
      ...
      <div className="w-12 h-12 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-white to-gray-400 flex items-center justify-center transition-transform duration-300 hover:scale-105 shadow-md">
        <img
          src={logoIcon}
          alt="Logo Icon"
