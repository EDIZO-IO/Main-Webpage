        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className={`
              ...
              ${isScrolled
                ? 'h-16 bg-white/60 shadow-lg shadow-gray-200/50 border border-white/40'
                : 'h-18 bg-white/10 shadow-md shadow-gray-100/30 border border-white/20'}
            `}
            style={{
            ...
            <button
              className={`
                ...
                ${isMenuOpen
                  ...
                  : 'bg-gray-50/20 text-white-700 hover:bg-gray-200/80'}
              `}
