    ...
    <div className="bg-white min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        <AnimatedSection delay={0.2}>
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-2">
              Welcome Back to <span className="text-red-500">EDIZO</span>
            </h1>
        ...
        <AnimatedSection delay={0.3}>
          <form onSubmit={handleLogin} className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 md:p-8 shadow-xl border border-white/20">
            <div className="space-y-5">
              ...
              {/* Submit Button — INLINED (no CTAButton component) */}
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-300 text-sm">
                ...
                <a href="/signup" className="text-red-400 hover:text-red-300 font-medium underline-offset-2 hover:underline">
                  Sign Up
                </a>
              </p>
              <p className="text-gray-400 text-xs mt-2">
                Forgot your password? <a href="#" className="hover:underline">Reset it</a>
              </p>
            </div>
          </form>
        </AnimatedSection>
