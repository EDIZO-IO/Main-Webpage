...
// === Memoized PageHeader with Video Background ===
...
const PageHeader = memo<PageHeaderProps>(({ title, subtitle, showVerifyButton }) => {
  return (
    ...
    >
      ...
      {/* Floating skill/service icons - Left */}
      <div className="absolute left-0 top-0 bottom-0 w-1/4 overflow-hidden pointer-events-none z-[3]">
        {[
          ...
          >
            <item.Icon size={22 + i * 2} strokeWidth={1.5} />
          </motion.div>
        ))}
      </div>

      {/* Floating skill/service icons - Right */}
      <div className="absolute right-0 top-0 bottom-0 w-1/4 overflow-hidden pointer-events-none z-[3]">
        {[
          ...
          >
            <item.Icon size={20 + i * 2} strokeWidth={1.5} />
          </motion.div>
        ))}
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {subtitle && (
            <motion.p
              className="text-lg md:text-xl font-medium max-w-2xl mx-auto text-white/80"
      ...
      <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-white to-transparent z-[4]" />
    </section>
  );
});
