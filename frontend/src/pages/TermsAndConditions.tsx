        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                You may not reproduce, distribute, modify, create derivative works of, publicly display, publicly perform, republish, download, store, or transmit any of our intellectual property except as expressly permitted by these Terms or as authorized in writing by EDIZO.
              </p>
              <p className="text-gray-700 leading-relaxed">
            ...
            >
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                ...
                <li>Any damages resulting from any third-party content or services</li>
              </ul>
              <p className="text-gray-700 leading-relaxed">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                We reserve the right to modify or replace these Terms at any time. Changes will be effective immediately upon posting the revised Terms on our website. Your continued use of our services after the posting of any changes constitutes acceptance of those changes.
              </p>
              <p className="text-gray-700 leading-relaxed">
                We will notify you of any material changes to these Terms through our website or other communication methods. It is your responsibility to review these Terms periodically for changes.
              </p>
            </motion.div>
