...
const blogData = {
  ...
  featured,
  content,
  authorImage: "", // Add required property
  slug: id, // Add required property
  seoDescription: description, // Add required property
  keywords: [], // Add required property
  status: "published" as const, // Add required property with correct type
  excerpt: description, // Add required property
  updatedAt: publishedDate // Add required property
};
  return (
    <AnimatedSection>
      <BlogCard 
        blog={blogData} 
        onClick={() => {}} // No-op since we're not using modal on home page
      />
    </AnimatedSection>
  );
});
