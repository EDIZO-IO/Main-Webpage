      ...
      <section className="py-16 bg-gradient-to-r from-gray-50 via-white to-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="mt-12 text-center">
            <AnimatedSection>
              <div className="inline-flex items-center gap-2 px-5 py-2 bg-red-100/80 backdrop-blur-sm text-red-700 rounded-full font-medium text-sm mb-5 border border-red-100/50">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                Transparent Pricing
              </div>
              <h3 className="text-xl font-semibold text-gray-800 mb-3">Affordable Packages</h3>
              <p className="text-gray-600 max-w-lg mx-auto mb-6">
                Get custom pricing for all our services with no hidden costs. View our transparent pricing structure.
              </p>
