  ...
  <AnimatedSection delay={index * 0.05}>
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        />
        {/* Icon chip */}
        <div className="absolute top-5 left-5 flex items-center justify-center w-12 h-12 backdrop-blur-sm bg-white/80 border border-gray-200 rounded-lg shadow group-hover:bg-red-50 transition-colors z-10">
          {service.icon}
        </div>
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mb-4 flex flex-wrap gap-2">
          {service.features.slice(0, 3).map((feature, i) => (
            <span key={i} className="text-xs bg-gradient-to-r from-red-50 to-orange-50 text-red-700 px-3 py-1 rounded font-medium border border-red-100">
              {feature}
            </span>
          ))}
        ...
        <Button
          ...
          className="w-full mt-auto rounded-lg border-none font-bold shadow-none transition-colors"
          ...
          <div className="mb-12">
            ...
            {activeFilterCount > 0 && (
              <motion.div
                ...
                className="flex items-center justify-between backdrop-blur-sm bg-red-50/80 border border-red-200 rounded-xl p-4"
              >
                ...
                <button
                  ...
                  className="text-sm text-red-600 hover:text-red-800 font-semibold flex items-center gap-1 hover:underline"
                >
                  <X size={14} />
                  Clear all filters
                </button>
          ...
          <AnimatePresence mode="wait">
            {filteredServices.length > 0 ? (
              ...
              <motion.div
                ...
                className="text-center py-20 backdrop-blur-sm bg-gradient-to-br from-gray-50/80 to-red-50/50 rounded-3xl border-2 border-gray-200"
              >
          ...
          <AnimatedSection>
            <div className="mt-12">
              <motion.div
                ...
                className="bg-gradient-to-r from-red-600 via-orange-500 to-red-500 rounded-2xl p-8 shadow-xl overflow-hidden relative"
              >
                {/* Background Pattern */}
